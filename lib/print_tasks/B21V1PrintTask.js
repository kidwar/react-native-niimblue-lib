...
class B21V1PrintTask extends AbstractPrintTask_1.AbstractPrintTask {
    ...
    waitForFinished() {
        ...
        return this.abstraction
            .waitUntilPrintFinishedByPrintEndPoll(this.printOptions.totalPages ?? AbstractPrintTask_1.PrintOptionsDefaults.totalPages, this.printOptions.statusPollIntervalMs ??
